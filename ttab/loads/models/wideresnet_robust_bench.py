'''
code copy from `robustbench` repo
'''
import math
import torch
...
class WideResNetRB(nn.Module):
    """ Based on code from https://github.com/yaodongyu/TRADES """
    def __init__(self, depth=28, num_classes=10, widen_factor=10, sub_block1=False, dropout_rate=0.0, bias_last=True):
        super().__init__()
